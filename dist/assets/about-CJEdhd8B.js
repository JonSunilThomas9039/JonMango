import{i as r,a}from"./navigation-mEJfUY_d.js";document.addEventListener("DOMContentLoaded",()=>{r(),a(),d()});function c(){const e=document.getElementById("about-promo-iframe");if(e&&e.contentWindow)try{e.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',"*")}catch{}}function d(){const e=document.getElementById("about-play-promo-btn"),o=document.getElementById("about-promo-container");e&&o&&(e.addEventListener("click",t=>{t.preventDefault(),o.innerHTML=`
